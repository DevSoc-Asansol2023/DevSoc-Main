...
<div className="bg-[#0D1117] h-[70vh] lg:min-h-screen flex flex-row items-center sm:flex flex-column font-inter">
  ...
  <div className="flex flex-col items-start max-w-md p-0 mt-10">
    <div className="md:flex md:flex-row sm:flex-col">
      <div className="flex flex-col">
        ...
        <p className="mb-10 text-gray-300">Start your journey with Devsoc. Sign Up now!</p>
        <div className="flex flex-col mb-4 md:flex-row">
          <input
            type="text"
            placeholder="Enter your email"
            className="w-full px-4 py-2 font-sans text-black bg-white border md:rounded-l-lg focus:outline-none focus:ring focus:ring-purple-600 sm:w-96"
          />
          <button className="w-24 h-12 px-4 py-2 mt-0 text-white bg-purple-600 sm:w-40 sm:h-16 md:rounded-r-lg hover:bg-purple-700 focus:outline-none">
            Sign up
          </button>
        </div>
      ...
      <img
        src={animatedIcon}
        alt="Connect"
        className="hidden ml-40 w-96 h-80 lg:block"
      />
    </div>
  </div>
</div>
